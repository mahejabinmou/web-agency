  ...
  return (
    <section className="relative z-[1] mt-[-60px] mb-[-60px]">
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        <div className="relative z-[2] flex flex-col lg:flex-row justify-between items-center bg-[#ffae00] text-black rounded-lg px-10 py-24 overflow-hidden">
          <h2 className="text-[18px] leading-[30px] lg:text-[60px] font-medium uppercase lg:leading-[0.9] text-center lg:text-left mb-8 lg:mb-0">
            Let's Get Your Project <br /> Started!
          </h2>
          <div>
            <a
              href="#"
              className="inline-block bg-black text-white px-6 py-3 rounded-md text-sm font-semibold hover:bg-white hover:text-[#ffae00] transition"
            >
              Contact with us
            </a>
          </div>
